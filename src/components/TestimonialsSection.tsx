...
export const TestimonialsSection = () => {
  return (
    <section className="py-20 bg-grid-white/[0.02] relative overflow-hidden">
      ...
      <div className="h-[25rem] rounded-md flex flex-col antialiased bg-transparent dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
        <InfiniteMovingCards
          items={testimonials}
          direction="right"
          speed="slow"
